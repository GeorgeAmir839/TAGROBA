...
<body>
    ...
    <div class="card uper">
        <div class="card-header">
            ...
            <a href="{{ url('/doctor/create') }}" class='btn btn-dark'> Register form </a>
            
            <a href="{{ url('/logindoctor') }}" class='btn btn-light border border-dark'> login form </a>
            ...
            <div class="row">
                @foreach ($data as $row)
                    ...
                    <div class="col-xs-2 col-sm-2 col-md-3 row justify-content-arouned">
                        ...
                        <div class="form-group">
                            <form action="{{ url('/doctor/' . $row->id)}}" method="post">
                                @csrf
                                    @method("delete")
                                <td>
                            ...
                            <a href="{{ url('/doctor/' . $row->id . '/edit') }}"class="btn btn-primary m-r-1em">Edit</a>
                            <a href="{{ url('/doctor/' . $row->id ) }}"class="btn btn-success m-r-1em">show</a>
                            <a href="{{ url('/logoutdoctor' ) }}"class="btn btn-dark m-r-1em">logout</a>
