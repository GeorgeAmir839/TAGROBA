...
<body>
    ...
    <div class="card uper">
        <div class="card-header">
            ...
            <a href="{{ url('/doctor') }}" class='btn btn-light border border-dark'> Returen To Show All User </a>
            <a href="{{ url('/logindoctor') }}" class='btn btn-dark border border-dark'> login form </a>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 row justify-content-arouned">
                    ...
                    <div class="form-group p-3">
                        ...
                        <a href="{{ url('/doctor/' . $data->id) }}" class="btn btn-danger m-r-1em mx-2">Delete</a>
                        <a href="{{ url('/doctor/' . $data->id . '/edit') }}" class="btn btn-primary m-r-1em mx-4">Edit</a>
